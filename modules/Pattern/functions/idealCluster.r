suppressPackageStartupMessages(require(tidyverse,warn.conflicts = FALSE,quietly = TRUE))
suppressPackageStartupMessages(require(stats,warn.conflicts = FALSE))
suppressPackageStartupMessages(require(broom,warn.conflicts = FALSE))

# Functions depend on the following format:
# sent | dim1 | dim2 ... dimn

selectByIdeal <- function(data,tracerData,s2v,mod_vec,sentColumn,kTries = 10){
